...
\usepackage[pdftitle={SOP},pdfauthor={Jens Tinggaard}, hidelinks, bookmarks=true, bookmarksopen=true]{hyperref} %References
...
\addcontentsline{toc}{section}{Forord / Motivation}
\input{sections/forord.tex}


\newpage
\section{Talteori}
\input{sections/talteori2.tex}
