...
Derfor følger man ikke protokollen fra eksempel \ref{genrsa} i praksis, men bruger i stedet en symmetrisk krypterings algoritme (som f.eks. \texttt{AES} Advanced Encryption Standard), som er kendetegnet ved, at den bruger samme nøgle til kryptering og dekryptering og samtidig ikke er på så mange bit (128 bit), som en asymmetrisk krypteringsnøgle (som RSA). \cite{xolphin}
