...
Det skal ses hvordan man kan forsøge at finde frem til den originale besked, på trods af hashets envejs-egenskab.
    ...
    Et \emph{rainbow table} er en tabel, hvori der ligger nogle forudberegnede hashes, samt de originale kodeord dertil.
    Det gør at man, uden at være nødt til at brute-force alle \(29^n\) muligheder, kan finde finde frem til en brugers kodeord.
